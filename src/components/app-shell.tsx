...
export function AppShell({ children, user, onLogout }: AppShellProps) {
  ...
  return (
    <div className="relative z-10 grid min-h-screen w-full grid-cols-[240px_1fr] bg-[color:var(--bg)]">
      <aside className="sticky top-0 flex h-screen flex-col overflow-y-auto border-r border-[color:var(--border)] bg-[color:var(--bg-2)] px-4 py-6 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[color:var(--border-strong)]">
